...
if(!empty($jsapi_ticket)){
   ...
   //$urls = "$protocol$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    if(!empty($_GET['type'])){
        $urls   = "http://www.heigushop.com/Web/html/address.html?type={$_GET['type']}&title={$_GET['title']}&hreftype={$_GET['hreftype']}";
    }else{
        $urls    = "http://www.heigushop.com/Web/html/address.html?title=".$_GET['title'];
    }
