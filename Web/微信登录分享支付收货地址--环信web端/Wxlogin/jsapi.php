...
if(!empty($openId)){
   ...
   if(!empty($returndata)){
       ...
       if($returndata1->code==200){
           ...
           $loginurl   = "http://www.heigushop.com/Web/html/index2.php?username=$userName&phone=$Phone&photo=$Photo&account=$account&intl=$intl&isseller=$isseller&ispaypwd=$ispaypwd&token=$token&logintype=$login_type&openid=$openids&city=$city";
