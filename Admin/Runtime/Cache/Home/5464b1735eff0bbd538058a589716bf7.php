...
<body class="mainbody">
    ...
    <div class="tools_box">
        ...
        <input class="laydate-icon" value="<?php echo ($st); ?>"  id="st"  readonly="readonly" onclick="laydate({format: 'YYYY-MM-DD',festival: true, choose: function(datas){  }})" style="width:90px;height:20px;">-<input class="laydate-icon" value="<?php echo ($ed); ?>"  id="ed"  readonly="readonly" onclick="laydate({format: 'YYYY-MM-DD',festival: true, choose: function(datas){  }})" style="width:90px;height:20px;">
