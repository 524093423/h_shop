...
class VerificationModel extends Model {
	 ...
	 * @return boolean
	 */
	public static function isPayPWD($value,$minLen=6,$maxLen=6){
		$match='/^[\\~!@#$%^&*()-_=+|{}\[\],.?\/:;\'\"\d\w]{'.$minLen.','.$maxLen.'}$/';
		$v = trim($value);
		if(empty($v))
			return false;
	...
	//验证银行卡号合法性(免费)
	public static function check_cardno($cardno){
		$str = "https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo={$cardno}&cardBinCheck=true";
